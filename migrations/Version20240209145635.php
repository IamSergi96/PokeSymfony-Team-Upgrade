 ...
 */
final class Version20240209145635 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE debilidad (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE pokemon_debilidad (pokemon_id INT NOT NULL, debilidad_id INT NOT NULL, INDEX IDX_1EBD3D3F2FE71C3E (pokemon_id), INDEX IDX_1EBD3D3FD7C99BD5 (debilidad_id), PRIMARY KEY(pokemon_id, debilidad_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
